...
export async function emitirPessoa(dados:DadosEmissao, assinatura:ReturnType<typeof assinaturaService>, repo:UsuariosRepository, coletas:ColetasRepository) {
  ...
  try {
    ...
    await repo.salvar(chip); return chip;
